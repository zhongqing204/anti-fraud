NEW_FILE_CODE
D:\anti-fraud\frontend\AntiFraud-frontend\src\views\admin\ActivityComments.vue
<template>
  <div>
    <!-- ===== 搜索区域 ===== -->
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="activityTitle" label="活动标题" width="200" show-overflow-tooltip align="center" />
